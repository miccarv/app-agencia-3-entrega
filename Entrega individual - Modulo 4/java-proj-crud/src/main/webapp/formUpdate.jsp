          ...
          <div style="width:70%">
            ...
            <form action="ClienteUpdate" method="POST">
              ...
              <div class="form-floating mb-3">
                <input value="${cliente.nome}" name="nome" maxlength="40" type="text" class="form-control"
                  id="floatingInput1">
                <label>Nome completo</label>
              </div>
              <div class="form-floating mb-3">
                <input value="${cliente.email}" name="email" maxlength="40" type="email" class="form-control">
                <label>Email</label>
              </div>
              <div class="form-floating mb-3">
                <input value="${cliente.senha}" name="senha" type="text" class="form-control" placeholder="Senha">
                <label>Senha</label>
              </div>
              <div class="form-floating mb-3">
                <input value="${cliente.endereco}" name="endereco" type="text" class="form-control"
                  placeholder="Endereço">
                <label>Endereço (Rua, Número e Cidade)</label>
              </div>

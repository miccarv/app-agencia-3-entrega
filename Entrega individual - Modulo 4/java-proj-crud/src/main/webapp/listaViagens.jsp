    ...
    <body class="home-bg">
      ...
      <div class="container-fluid text-white px-3" style="padding: 56px 0 56px 0;">
        <div class="row w-100">
              ...
              <tbody>
                <c:forEach items="${viagens}" var="viagem">
                  <tr>
                    ...
                    <td>${viagem.email}</td>
                    <td>${viagem.date}</td>
                    <td>${viagem.duration}</td>
                    <td>
                      <a href="ViagemDelete?viagemId=${viagem.id}">Deletar</a> |
                      <a href="ViagemUpdate?viagemId=${viagem.id}">Atualizar</a>
                    </td>
                  </tr>
                </c:forEach>
              </tbody>
          ...
          <h5><a href="destino.html">Voltar para o Cadastro de Viagens</a></h5>
        </div>
      </div>
